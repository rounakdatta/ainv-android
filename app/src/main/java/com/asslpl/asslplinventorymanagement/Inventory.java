...
public class Inventory {
    ...
    public Inventory(final String itemName, final String itemVariant, final String hsnCode, final String itemQuantity, final String uomRaw, final String smallboxQuantity, final String uomSmall, final String bigcartonQuantity, final String uomBig, final String warehouseName, final String warehouseLocation) {
